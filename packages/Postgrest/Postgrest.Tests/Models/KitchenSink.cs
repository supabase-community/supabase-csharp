...
public class KitchenSink : BaseModel
{
    ...
    [Column("datetime_value_1", NullValueHandling = JsonIgnoreCondition.WhenWritingNull)]
    public DateTime? DateTimeValue1 { get; set; }

    [Column("datetime_pos_infinite_value", NullValueHandling = JsonIgnoreCondition.WhenWritingNull)]
    public DateTime? DateTimePosInfinity { get; set; }

    [Column("datetime_neg_infinite_value", NullValueHandling = JsonIgnoreCondition.WhenWritingNull)]
    public DateTime? DateTimeNegInfinity { get; set; }

    [Column("list_of_strings")] public List<string>? ListOfStrings { get; set; }

    [Column("list_of_datetimes", NullValueHandling = JsonIgnoreCondition.WhenWritingNull)]
