...
namespace Supabase.Gotrue
{
    ...
    public class StatelessClient : IGotrueStatelessClient<User, Session>
    {
        ...
        /// <inheritdoc />
        public async Task<MfaEnrollResponse?> Enroll(string jwt, MfaEnrollParams mfaEnrollParams, StatelessClientOptions options) => await GetApi(options).Enroll(jwt, mfaEnrollParams);

        /// <inheritdoc />
        public async Task<MfaChallengeResponse?> Challenge(string jwt, MfaChallengeParams mfaChallengeParams, StatelessClientOptions options) => await GetApi(options).Challenge(jwt, mfaChallengeParams);

        /// <inheritdoc />
        public async Task<MfaVerifyResponse?> Verify(string jwt, MfaVerifyParams mfaVerifyParams, StatelessClientOptions options) => await GetApi(options).Verify(jwt, mfaVerifyParams);
        ...
        /// <inheritdoc />
        public async Task<MfaUnenrollResponse?> Unenroll(string jwt, MfaUnenrollParams mfaUnenrollParams, StatelessClientOptions options) => await GetApi(options).Unenroll(jwt, mfaUnenrollParams);
        ...
        public async Task<UserList<User>?> ListUsers(string serviceRoleToken, StatelessClientOptions options, string? filter = null, string? sortBy = null, SortOrder sortOrder = SortOrder.Descending,
            int? page = null, int? perPage = null) => await GetApi(options).ListUsers(serviceRoleToken, filter, sortBy, sortOrder, page, perPage);

        /// <inheritdoc />
        public async Task<User?> GetUserById(string serviceRoleToken, StatelessClientOptions options, string userId) => await GetApi(options).GetUserById(serviceRoleToken, userId);

        /// <inheritdoc />
        public async Task<User?> GetUser(string serviceRoleToken, StatelessClientOptions options) => await GetApi(options).GetUser(serviceRoleToken);
        ...
        /// <inheritdoc />
        public async Task<User?> CreateUser(string serviceRoleToken, StatelessClientOptions options, AdminUserAttributes attributes) => await GetApi(options).CreateUser(serviceRoleToken, attributes);
        ...
        public async Task<User?> UpdateUserById(string serviceRoleToken, StatelessClientOptions options, string userId, AdminUserAttributes userData) =>
            await GetApi(options).UpdateUserById(serviceRoleToken, userId, userData);
        ...
        /// <inheritdoc />
        public async Task<Session?> ExchangeCodeForSession(string codeVerifier, string authCode, StatelessClientOptions options) => await GetApi(options).ExchangeCodeForSession(codeVerifier, authCode);
