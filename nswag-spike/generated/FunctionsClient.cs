...
namespace Supabase.Functions.Gen
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class FunctionsClient : IFunctionsClient
    {
    ...
    #pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public FunctionsClient(System.Net.Http.HttpClient httpClient)
        ...
        public virtual async System.Threading.Tasks.Task<byte[]> InvokeFunctionDeleteAsync(string functionName, byte[]? body = null, System.Collections.Generic.IDictionary<string, string>? query = null, string? x_region = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "functions/v1/{functionName}"
                    urlBuilder_.Append("functions/v1/");
                    ...
                    if (query != null)
                    {
                        foreach (var item_ in query) { urlBuilder_.Append(System.Uri.EscapeDataString(item_.Key)).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(item_.Value, System.Globalization.CultureInfo.InvariantCulture))).Append('&'); }
                    }
                    urlBuilder_.Length--;
                    ...
                    try
                    {
                        ...
                        if (status_ == 400)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<FunctionsErrorResponseContent>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                            throw new ApiException<FunctionsErrorResponseContent>("FunctionsError 400 response", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
    ...
    public partial class FunctionsErrorResponseContent
    {
